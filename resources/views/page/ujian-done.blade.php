...
<body>
    <div class="container">
        <div class="card mt-2">
            <div class="card-body">
                <h4>Hii, {{ Auth::guard('siswa')->user()->nama }}</h4>
                <p>Anda telah menyelesaikan ujian. Untuk informasi mengenai nilai akan di umumkan oleh guru yang bersangkutan!</p>
                <p>Terimakasih.</p>
                <div class="float-right">
                    <a href="{{ route('daftar.ujian.siswa') }}">Tutup</a>
                </div>
            </div>
        </div>
    </div>
