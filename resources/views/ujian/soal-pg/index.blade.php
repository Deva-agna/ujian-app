    ...
    <div class="d-flex justify-content-between">
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('soal.pg.create', $ujian->slug) }}"><i class="fa-regular fa-file"></i> Create</a>
                <a class="dropdown-item" href="{{ route('soal.pg.pilih', $ujian->slug) }}"><i class="fa-regular fa-clipboard"></i> Pilih</a>
        ...
        <div class="heading-elements">
            <ul class="list-inline mb-0">
                <li>
                    ...
                    <a href="{{ route('soal.pg.edit', $list->soal->slug) }}" class="badge badge-primary"><i class="fa-solid fa-file-pen"></i></a>
                    @endif
                    <form id="form-delete{{$list->soal->id}}" action="{{route('soal.destroy.list')}}" method="post" class="d-inline">
                        ...
                        <button class="btn-hapus badge badge-danger border-0" data-id="{{$list->soal->id}}"><i class="fa-solid fa-trash-can"></i></button>
                    </form>
                </li>
                <li>
