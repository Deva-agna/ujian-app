                ...
                <form action="{{ route('mapel.update') }}" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_mapel" class="form-control form-control-sm @error('nama_mapel') is-invalid @enderror" id="nama_mapel" placeholder="Masukan Mata Pelajaran" value="{{old('nama_mapel', $mapel->nama_mapel)}}">
                            @error('nama_mapel')
                        ...
                        <a href="{{ route('mapel') }}" class="btn btn-sm btn-secondary waves-effect waves-float waves-light">Kembali</a>
