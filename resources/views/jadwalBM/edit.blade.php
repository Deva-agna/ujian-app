            ...
            <div class="card">
                <form action="{{ route('jadwalBM.update') }}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="hari">Mapel yang diampu <span class="text-danger">*</span></label>
                            <select name="hari" class="form-control form-control-sm @error('hari') is-invalid @enderror" id="hari">
                                <option value="">Pilih</option>
                                <option {{ old('hari', $jadwalBM->hari) == 'senin' ? 'selected' : '' }} value="senin">Senin</option>
                                <option {{ old('hari', $jadwalBM->hari) == 'selasa' ? 'selected' : '' }} value="selasa">Selasa</option>
                                <option {{ old('hari', $jadwalBM->hari) == 'rabu' ? 'selected' : '' }} value="rabu">Rabu</option>
                                <option {{ old('hari', $jadwalBM->hari) == 'kamis' ? 'selected' : '' }} value="kamis">Kamis</option>
                                <option {{ old('hari', $jadwalBM->hari) == 'jumat' ? 'selected' : '' }} value="jumat">Jum`at</option>
                                <option {{ old('hari', $jadwalBM->hari) == 'sabtu' ? 'selected' : '' }} value="sabtu">Sabtu</option>
                            </select>
                            @error('hari')
                            <div class="invalid-feedback">
                                {{$message}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <input type="text" id="fp-time" name="jam_mulai" class="@error('jam_mulai') is-invalid @enderror form-control form-control-sm flatpickr-time text-left flatpickr-input active" placeholder="HH:MM" readonly="readonly" value="{{old('jam_mulai', $jadwalBM->jam_mulai)}}">
                                    @error('jam_mulai')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
                                ...
                                <div class="col-md-6 form-group">
                                    <input type="text" id="fp-time" name="jam_selesai" class="@error('jam_selesai') is-invalid @enderror form-control form-control-sm flatpickr-time text-left flatpickr-input active" placeholder="HH:MM" readonly="readonly" value="{{old('jam_selesai', $jadwalBM->jam_selesai)}}">
                                    @error('jam_selesai')
                                    <div class="invalid-feedback">
                                        {{$message}}
                                    </div>
